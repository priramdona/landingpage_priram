    ...
    <div class="container">
        <nav class="navbar navbar-dark navbar-expand-lg py-0">
            <a href="{{ url('/') }}" class="navbar-brand">
                <h1 class="text-white fw-bold d-block">PRIRAM<span class="text-secondary">.com</span></h1>
            </a>
            ...
            <div class="collapse navbar-collapse bg-transparent" id="navbarCollapse">
                <div class="navbar-nav ms-auto mx-xl-auto p-0">
                    ...
                    <!-- Projects -->
                    <a href="{{ url('/projects') }}" class="nav-item nav-link {{ Request::is('projects') ? 'active' : '' }}">Products</a>
            ...
            <div class="d-none d-xl-flex flex-shrink-0">
                ...
                <div class="d-flex flex-column pe-4 border-end">
                    ...
                    <span class="text-secondary">Call: +62 813 145 69 045</span>
                </div>
